...
<body>
    ...
    <main class="main-section">
        <h1 class="details-title">Crear Proyecto</h1>
        <form id="datos" method="post" action="addUnProyecto.php" class="colortexto project-form">
            <br>
            ...
            <br>
            <input type="reset" value="Limpiar" class="details-button btn-reset">
            <input type="submit" value="Crear" class="details-button btn-submit">
        </form>
        <script>
